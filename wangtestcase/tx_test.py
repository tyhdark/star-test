...
# print(Tx.Bank.send_to_admin(amount=100000)) # 国库转账给管理员
# Tx.Wait.wait_five_seconds()
...
# print(Tx.Bank.send_tx(from_addr=Tx.super_addr,to_addr=addre,amount=100000)) # 管理员给用户转钱
# Tx.Wait.wait_five_seconds()
#
...
#         print(name)
    #     Tx.Keys.delete(user_name=i['name'])
